    ...
    return (
        <div className="flex flex-col lg:flex-row gap-4 p-3 rounded-lg w-full transition-colors duration-300" style={themeStyle}>
            ...
            <div className="w-full lg:w-[230px] flex-shrink-0 flex flex-col gap-3">
                ...
                {/* Selection Details — moved higher */}
                <div className="mt-2">
                    {selectedEl ? (
                        <article className="bg-card border-l-2 border-primary p-3 shadow-xl animate-in fade-in slide-in-from-right-2">
                            <div className="flex justify-between items-start gap-2 mb-3">
                                ...
                                <button onClick={() => setSelectedEl(null)} className="hover:bg-muted p-0.5 rounded">
                                    <X className="w-3 h-3" />
                                </button>
                            </div>
                        ...
                        <div className="text-[10px] text-center py-4 border border-dashed border-border text-muted-foreground/50 uppercase tracking-widest">
                            No Selection
                        </div>
                    )}
                </div>
